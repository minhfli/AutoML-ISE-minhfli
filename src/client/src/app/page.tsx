  ...
  */
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <button className="btn btn-outline btn-accent fixed left-0 top-16 lg:top-0 flex w-full cursor-pointer justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl transition duration-300 ease-in-out hover:bg-gray-100 hover:text-gray-800 lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:dark:bg-zinc-800/30">
  ...
  <code className="font-mono font-bold">proudly made by RD320 lab</code>
      ...
      <div className="mb-32 grid gap-4 text-center md:grid-cols-2 sm:grid-cols-1 lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left lg:gap-8 justify-between">
        {messages.map((message, index) => (
          <Link
            key={index || message.id} // meoew meow grrrrrrrr
            href={message.href}
            prefetch={true}
