...
const CsvParser: React.FC = () => {
  ...
  <table className="min-w-full bg-white">
    <thead>
      <tr>
        <th className="py-2 px-4 bg-gray-200 font-semibold text-sm text-gray-600 border-b border-gray-200">Quality</th>
        <th className="py-2 px-4 bg-gray-200 font-semibold text-sm text-gray-600 border-b border-gray-200">Fixed Acidity</th>
        <th className="py-2 px-4 bg-gray-200 font-semibold text-sm text-gray-600 border-b border-gray-200">Volatile Acidity</th>
        <th className="py-2 px-4 bg-gray-200 font-semibold text-sm text-gray-600 border-b border-gray-200">Citric Acid</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td className="py-2 px-4 text-sm text-gray-700 border-b border-gray-200">5</td>
        <td className="py-2 px-4 text-sm text-gray-700 border-b border-gray-200">7.4</td>
        <td className="py-2 px-4 text-sm text-gray-700 border-b border-gray-200">0.7</td>
        <td className="py-2 px-4 text-sm text-gray-700 border-b border-gray-200">0</td>
      </tr>
      {/* <!-- ... more rows ... --> */}
    </tbody>
  </table>
