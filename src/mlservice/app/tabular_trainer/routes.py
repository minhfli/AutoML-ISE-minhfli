...
from app.tabular_classifier.model import TrainingRequest
from app.tabular_classifier.autogluon_trainertabular_classifier.autogluon_trainer import AutogluonTrainer
from app.tabular_classifier.autogluon_predictor import AutogluonPredictor
...
@router.post("/api/tabular_classifier/train", tags=["tabular_classifier"])
...
@router.post("/api/tabular_classifier/predict", tags=["tabular_classifier"])
async def predict(
...
@router.post("/api/tabular_classifier/accuracy", tags=["tabular_classifier"])
